...
const InfoList = () => {
    return <div className="flex items-center flex-wrap justify-around gap-10 mt-6 sm:mt-10 sm:gap-x-20 sm:justify-center">
        <Info titulo={"Endereço"} info={"Fortaleza-CE"} icone={"/imagens/endereco.svg"}/>
        <Info titulo={"Email"} info={"abraaorudson1@gmail.com"} icone={"/imagens/email.svg"} url={'mailto:abraaorudson1@gmail.com'}/>
